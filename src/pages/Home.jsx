    ...
    return (
      <div className="home-container">
        ...
        <div className="home-about-container">
          ...
          University. <br/> My primary interest is full stack web
          development. <br/>   Here you can check out some of the things I've
        ...
        <div className="content home-featured-post-container">
          <FeaturedPost postId="12" 
                        tagLine="behind the scenes" 
                        catLabel="view all work"
                        catLink="/code"/>
          <FeaturedPost postId="20" 
                        tagLine="3d art" 
                        catLabel="view all blog posts"
                        catLink="/code"/>              
